...
OSLOCFG_BRANCH=1.4.0.0a3
OSLOMSG_BRANCH=stable/icehouse
OSLORWRAP_BRANCH=1.2.0
OSLODB_BRANCH=0.1.0
OSLOVMWARE_BRANCH=0.3
PYCADF_BRANCH=0.5
STEVEDORE_BRANCH=0.15
TASKFLOW_BRANCH=0.2
KEYSTONECLIENT_BRANCH=0.10.0
GLANCECLIENT_BRANCH=0.12.0
CINDERCLIENT_BRANCH=1.0.8
NOVACLIENT_BRANCH=2.17.0
SWIFTCLIENT_BRANCH=2.0.3
NEUTRONCLIENT_BRANCH=2.3.4
KEYSTONEMIDDLEWARE_BRANCH=master
OPENSTACKCLIENT_BRANCH=0.3.1
KEYSTONE_BRANCH=$OS_BRANCH
GLANCE_BRANCH=$OS_BRANCH
NOVNC_BRANCH=master
NOVA_BRANCH=$OS_BRANCH
...
class JunoNeutronTest(NexusTestCase):
